 /*
* IsaBot es una creación de Dragón
* IsaBot no tiene ningun fin de lucro
...
function addMetadata(packname, author) {	
	if (!packname) packname = 'Dragón'; if (!author) author = 'Dragón';	
...
/******ENTRADA FIN DE FUNCIONES******/
			function addMetadata(packname, author) {	
				if (!packname) packname = 'ShanBot'; if (!author) author = 'Dragón';	
				author = author.replace(/[^a-zA-Z0-9]/g, '');	
				let name = `${author}_${packname}`
